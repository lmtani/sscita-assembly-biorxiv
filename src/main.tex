...
\begin{abstract}
  ...
  for sugarcane smut disease, generated primarily from PacBio
  ...
  present an updated genome version, re-polished using newly
  generated high-quality Illumina short-read data and
  state-of-the-art variant-calling workflows, resulting in
  corrections at approximately 5,500 genomic positions, predominantly
  correcting SNP and indel errors. BUSCO benchmarking in protein mode
  demonstrated increased genome completeness from the original 94.2\%
  to 99.3\%, indicating substantial improvements in both accuracy and
  gene annotation reliability. This enhanced genome assembly provides
  a significantly improved reference resource, enabling more robust
  genetic, evolutionary, and functional studies of this economically
...
data. The resulting genome resource represents an advancement,
facilitating more accurate genetic, evolutionary, and functional
